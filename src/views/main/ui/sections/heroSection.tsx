...
export const HeroSection = () => {
	return (
		<section
			...
			className="relative flex min-h-screen items-center pb-20 pt-28"
		>
			<div className="container grid items-center gap-12 lg:grid-cols-[1.02fr_0.98fr]">
				<div data-motion="hero-copy" className="max-w-4xl">
					<p className="mb-6 inline-flex rounded-full border border-border bg-card/60 px-4 py-2 text-sm text-primary backdrop-blur">
						Frontend developer crafting quiet, cinematic interfaces
					</p>
					...
					<p className="mt-8 max-w-2xl text-lg leading-8 text-muted-foreground sm:text-xl">
						I design and build polished web products where engineering clarity
						meets cinematic art direction, subtle motion and high-end frontend
						detail.
					</p>
					<div className="mt-9 flex flex-wrap gap-3">
						...
						<a
							...
							target="_blank"
							className="inline-flex items-center gap-2 rounded-full border border-border bg-card/60 px-6 py-3 font-medium backdrop-blur transition hover:bg-muted"
						>
