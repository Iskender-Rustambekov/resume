	...
	return (
		<section id="contact" className="relative py-24">
			<div className="container">
				<div
					data-motion="reveal"
					className="relative overflow-hidden rounded-[2rem] border border-border bg-card/75 p-8 shadow-2xl backdrop-blur-xl sm:p-12 lg:p-16"
				>
					...
					<div className="relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
						<div>
							...
							<h2 className="max-w-4xl text-[clamp(3rem,8vw,8rem)] font-semibold leading-[0.9] tracking-normal">
								Let us make the interface feel inevitable.
							</h2>
						</div>
