			...
			<div className="container grid items-center gap-12 lg:grid-cols-[1.02fr_0.98fr]">
				<div data-motion="hero-copy" className="max-w-4xl">
					...
					<p className="mt-8 max-w-2xl text-lg leading-8 text-muted-foreground sm:text-xl">
						4+ years of commercial experience building web products with React,
						Next.js and TypeScript. Focused on complex product logic, API-heavy
						flows, real-time behavior and frontend architecture for scalable
						applications.
					</p>
